...
L_best = np.load("./cvx_mf_realdata_v4/L_hat_cvx_mf_B{}_noise{}_p{}_eps{}.npy".format(Block_size, N_noise, p_, 0.01))
best_val = 1000.0

for EPS in [0.01, 0.1, 0.2, 0.3]:
    L = np.load("./cvx_mf_realdata_v4/L_hat_cvx_mf_B{}_noise{}_p{}_eps{}.npy".format(Block_size, N_noise, p_, EPS))
    M_diff = M - L
...
for threshold in [0.05, 0.1, 0.15, 0.2]:
    ...
    if recovery_error < recovery_error_best:
        ...
        # plt.savefig(
        #     './cvx_mf_realdata_v4/heatmap_cvx_mf_B{}_noise{}_p{}_threshold{}_eps{}.png'.format(Block_size, N_noise, p_, threshold, EPS),
        #     bbox_inches='tight')
        plt.savefig(
            './cvx_mf_realdata_v4/heatmap_cvx_mf_B{}_noise{}_p{}_threshold{}.png'.format(Block_size, N_noise, p_, threshold),
            bbox_inches='tight')
...
#             fig.colorbar(im2, ax=ax2)
#             plt.savefig(
#                 './cvx_mf_realdata_v4/heatmap_cvx_mf_EPS{}_B{}_noise{}_p{}_threshold{}.png'.format(EPS, Block_size, N_noise, p_, threshold),
#                 bbox_inches='tight')
#
#     print('threshold_best: ', threshold_best)
