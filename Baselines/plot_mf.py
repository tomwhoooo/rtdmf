...
for threshold in [0.05, 0.1, 0.15, 0.2, 0.25]:
    ...
    plt.savefig('./{}/results_cvx_mf_{}/single_best_heatmap_cvx_mf_eps{}_{}_threshold{}.png'.format(args.file_dir,
                                                                                                    args.file_name,
                                                                                                    best_eps,
                                                                                                    args.file_name,
                                                                                                    threshold),
    ...
    # plt.savefig('./{}/results_cvx_mf_{}/best_heatmap_cvx_mf_eps{}_{}_threshold{}.png'.format(args.file_dir,
    #                                                                                          args.file_name,
    #                                                                                          best_eps,
    #                                                                                          args.file_name,
    #                                                                                          threshold),
