...
L_best = np.load(
    './{}/results_cvx_rpca_{}/L_hat_cvx_rpca_{}_tau{}.npy'.format(args.file_dir, args.file_name, args.file_name, 0.1))

best_val = 1000.0
best_tau = 0.0
for TAU in [0.1, 0.2, 0.5, 1.0, 2.0, 5.0]:
    L = np.load(
        './{}/results_cvx_rpca_{}/L_hat_cvx_rpca_{}_tau{}.npy'.format(args.file_dir, args.file_name, args.file_name,
                                                                      TAU))
    M_diff = M - L
...
for threshold in [0.05, 0.1, 0.15, 0.2, 0.25]:
    ...
    plt.savefig('./{}/results_cvx_rpca_{}/singlebest_heatmap_cvx_rpca_tau{}_{}_threshold{}.png'.format(args.file_dir,
                                                                                                 args.file_name,
                                                                                                 best_tau,
                                                                                                 args.file_name,
                                                                                                 threshold),
    ...
    # plt.savefig('./{}/results_cvx_rpca_{}/best_heatmap_cvx_rpca_tau{}_{}_threshold{}.png'.format(args.file_dir,
    #                                                                                              args.file_name,
    #                                                                                              best_tau,
    #                                                                                              args.file_name,
    #                                                                                              threshold),
