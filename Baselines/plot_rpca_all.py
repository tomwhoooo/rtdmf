...
for TAU in [0.1, 0.2, 0.5, 1.0, 2.0, 5.0]:
    ...
    for threshold in [0.05, 0.1, 0.15, 0.2, 0.25]:
        ...
        plt.savefig('./{}/results_cvx_rpca_{}/single_heatmap_cvx_rpca_tau{}_{}_threshold{}.png'.format(args.file_dir,
                                                                                                args.file_name,
                                                                                                best_tau,
                                                                                                args.file_name,
                                                                                                threshold),
        ...
        # plt.savefig('./{}/results_cvx_rpca_{}/heatmap_cvx_rpca_tau{}_{}_threshold{}.png'.format(args.file_dir,
        #                                                                                         args.file_name,
        #                                                                                         best_tau,
        #                                                                                         args.file_name,
        #                                                                                         threshold),
